...
Reader1:
str := 1
FileRead, savedURLs, %A_Appdata%/Eudaimonia/urls1.txt
FileReadLine, savedName, %A_Appdata%/Eudaimonia/set1url.txt, 1
FileReadLine, savedTimePeriod, %A_Appdata%/Eudaimonia/set1url.txt, 2
FileReadLine, savedTimeLimit, %A_Appdata%/Eudaimonia/set1url.txt, 3
FileReadLine, savedMon, %A_Appdata%/Eudaimonia/set1url.txt, 4
FileReadLine, savedTue, %A_Appdata%/Eudaimonia/set1url.txt, 5
FileReadLine, savedWed, %A_Appdata%/Eudaimonia/set1url.txt, 6
FileReadLine, savedThu, %A_Appdata%/Eudaimonia/set1url.txt, 7
FileReadLine, savedFri, %A_Appdata%/Eudaimonia/set1url.txt, 8
FileReadLine, savedSat, %A_Appdata%/Eudaimonia/set1url.txt, 9
FileReadLine, savedSun, %A_Appdata%/Eudaimonia/set1url.txt, 10
FileReadLine, savedOver, %A_Appdata%/Eudaimonia/set1url.txt, 11
FileReadLine, savedEvery, %A_Appdata%/Eudaimonia/set1url.txt, 12
...
; When to block
Gui, Add, Text,, Enter the time periods within which to block these sites (optional):
Gui, Add, Edit, y+8 w200 vAllDayField gPrefs limit9, %savedTimePeriod%
Gui, Add, Button, x+10 w50 h25 gAllDay, All day

Gui, Add, Text, x10, Enter a time limit after which to block these sites (optional):
...
Gui, Add, Text, x10 y+8, Select the days on which to block these sites:
...
Submit_URL:
	FileDelete, %A_Appdata%/Eudaimonia/urls%str%.txt
    FileAppend, %URL%, %A_Appdata%/Eudaimonia/urls%str%.txt ; Issues with deleting last char
	Gui, Submit, NoHide
	FileDelete, %A_Appdata%/Eudaimonia/urls%str%.txt
    FileAppend, %URL%, %A_Appdata%/Eudaimonia/urls%str%.txt ; Issues with deleting last char
	Gui, Submit, NoHide
...
str := SubStr(str, 7, 7)
FileRead, savedURLs, %A_Appdata%/Eudaimonia/urls%str%.txt
FileReadLine, savedName, %A_Appdata%/Eudaimonia/set%str%url.txt, 1
FileReadLine, savedTimePeriod, %A_Appdata%/Eudaimonia/set%str%url.txt, 2
FileReadLine, savedTimeLimit, %A_Appdata%/Eudaimonia/set%str%url.txt, 3
FileReadLine, savedMon, %A_Appdata%/Eudaimonia/set%str%url.txt, 4
FileReadLine, savedTue, %A_Appdata%/Eudaimonia/set%str%url.txt, 5
FileReadLine, savedWed, %A_Appdata%/Eudaimonia/set%str%url.txt, 6
FileReadLine, savedThu, %A_Appdata%/Eudaimonia/set%str%url.txt, 7
FileReadLine, savedFri, %A_Appdata%/Eudaimonia/set%str%url.txt, 8
FileReadLine, savedSat, %A_Appdata%/Eudaimonia/set%str%url.txt, 9
FileReadLine, savedSun, %A_Appdata%/Eudaimonia/set%str%url.txt, 10
FileReadLine, savedOver, %A_Appdata%/Eudaimonia/set%str%url.txt, 11
FileReadLine, savedEvery, %A_Appdata%/Eudaimonia/set%str%url.txt, 12
